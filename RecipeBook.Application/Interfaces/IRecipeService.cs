...
public interface IRecipeService
{
    ...
    Task<RecipeDto> GetByIdAsync(Guid id, string requestingUserId, bool isAdmin = false, CancellationToken ct = default);
    Task<RecipeDto> CreateAsync(CreateRecipeRequest request, string ownerId, CancellationToken ct = default);
    Task<RecipeDto> UpdateAsync(Guid id, UpdateRecipeRequest request, string requestingUserId, bool isAdmin = false, CancellationToken ct = default);
    Task DeleteAsync(Guid id, string requestingUserId, bool isAdmin = false, CancellationToken ct = default);

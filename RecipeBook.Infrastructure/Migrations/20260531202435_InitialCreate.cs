        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceRecipeId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_recipes_recipes_SourceRecipeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_recipe_tags_RecipeId_Name",
                table: "recipe_tags",
                columns: new[] { "RecipeId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_recipes_OwnerId_Visibility",
                table: "recipes",
                columns: new[] { "OwnerId", "Visibility" });

            migrationBuilder.CreateIndex(
                name: "IX_recipes_SourceRecipeId",
                table: "recipes",

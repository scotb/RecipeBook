...
namespace RecipeBook.Infrastructure.Migrations
{
    ...
    [Migration("20260531205215_AddMealEntryRecipeFK")]
    partial class AddMealEntryRecipeFK
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipeBook.Domain.Entities.MealEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RecipeBook.Domain.Entities.MealPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RecipeBook.Domain.Entities.RecipeTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RecipeBook.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RecipeBook.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RecipeBook.Domain.Entities.MealEntry", b =>
                {
                    b.HasOne("RecipeBook.Domain.Entities.MealPlan", null)
                        .WithMany("Entries")
